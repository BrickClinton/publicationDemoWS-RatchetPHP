...
class Album extends ModelMaster{
  ...
  // Listar por usuario - mostrar todos 
  public function getSelectAlbumsByUser(array $data){
    try{
      return parent::execProcedure($data, "spu_albumes_listar_select_usuario", true);
    }
    catch(Exception $error){
      die($error->getMessage());
    }
